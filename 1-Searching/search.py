...
def branch_and_jump_graph_search(problem):
    """Search the deepest nodes in the search tree first. [p 74]"""
    return tree_search(problem, BranchJump())

def branch_and_jump_graph_sub_search(problem):
    """Search the deepest nodes in the search tree first. [p 74]"""
    return tree_search(problem, BranchJumpSub(problem))
